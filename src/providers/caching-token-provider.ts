...
export const CACHE_SEED_TOKENS: {
  ...
  [ChainId.TOKAMAK_GOERLI]: {
    TON: TON_TOKAMAK_GOERLI,
    TOS: TOS_TOKAMAK_GOERLI,
    USDC: USDC_TOKAMAK_GOERLI,
    USDT: USDT_TOKAMAK_GOERLI
  },
  [ChainId.TITAN]: {
    TON: TON_TITAN,
    TOS: TOS_TITAN,
  ...
  [ChainId.THANOS_SEPOLIA_TEST]: {
    ETH: ETH_THANOS_SEPOLIA_TEST,
    TOS: TOS_THANOS_SEPOLIA_TEST,
    USDC: USDC_THANOS_SEPOLIA_TEST,
    USDT: USDT_THANOS_SEPOLIA_TEST
  },
  [ChainId.TITAN_SEPOLIA]: {
    TON: TON_TITAN_SEPOLIA,
    TOS: TOS_TITAN_SEPOLIA,
    USDC: USDC_TITAN_SEPOLIA,
    USDT: USDT_TITAN_SEPOLIA
  },
  [ChainId.THANOS_SEPOLIA]: {
    ETH: ETH_THANOS_SEPOLIA,
    TOS: TOS_THANOS_SEPOLIA,
    USDC: USDC_THANOS_SEPOLIA,
    USDT: USDT_THANOS_SEPOLIA
  },
