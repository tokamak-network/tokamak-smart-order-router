...
export const usdGasTokensByChain: { [chainId in ChainId]?: Token[] } = {
  ...
  [ChainId.TITAN_SEPOLIA]: [TON_TITAN_SEPOLIA, TOS_TITAN_SEPOLIA, USDC_TITAN_SEPOLIA, USDT_TITAN_SEPOLIA],
  [ChainId.SEPOLIA]: [WTON_SEPOLIA, TOS_SEPOLIA, USDC_SEPOLIA, USDT_SEPOLIA],
  [ChainId.THANOS_SEPOLIA_TEST]: [ETH_THANOS_SEPOLIA_TEST, TOS_THANOS_SEPOLIA_TEST, USDC_THANOS_SEPOLIA_TEST, USDT_THANOS_SEPOLIA_TEST],
  [ChainId.THANOS_SEPOLIA]: [ETH_THANOS_SEPOLIA, TOS_THANOS_SEPOLIA, USDC_THANOS_SEPOLIA, USDT_THANOS_SEPOLIA],
};
